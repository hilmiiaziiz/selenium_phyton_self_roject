...
class AksesTheExplorePage {

	@Given("Open The Explore Page")
	def OpenExplorePage() {
		WebUI.openBrowser('')
	...
	def VerifyMenuBar() {
		...
		println("Three Menu Bars have been showing")
	}


	@And("Access The Menu Bar")
	def AksesTheNewReleaseBar() {
	...
	def CloseTheBrowser() {
		WebUI.closeBrowser()
		println("The Browser Successfully closed")
	}
}